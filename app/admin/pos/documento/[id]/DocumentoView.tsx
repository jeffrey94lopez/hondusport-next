...
import type { Documento, DocumentoItem, Caja, CaiAutorizacion, ConfigMap } from '@/types'
import { formatearCorrelativo } from '@/lib/pos/fiscal'
import { formatPrice } from '@/lib/store/format'
import type { PagoConMetodo } from './page'
...
function numeroDocumento(documento: Documento): string {
